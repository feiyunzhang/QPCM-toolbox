...
from dataset_nvvl import TSNDataSetNVVL
...
def main():
    ...
    train_data_set = TSNDataSetNVVL("", args.train_list, num_segments=args.num_segments,
    ...
    val_data_set = TSNDataSetNVVL("", args.val_list, num_segments=args.num_segments,
                   new_length=data_length,
                   modality=args.modality,
                   random_shift=False,
                   transform=torchvision.transforms.Compose([
