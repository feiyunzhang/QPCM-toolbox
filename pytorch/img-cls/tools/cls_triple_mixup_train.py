...
from utils import Logger, AverageMeter, measure_model, accuracy, mkdir_p, savefig, mixup_data, mixup_criterion, mixup_data_triple, mixup_criterion_triple,\
...
def mixup_train(loader, model, criterion, optimizer, epoch, use_cuda):
    ...
    for batch_idx, (inputs, targets) in enumerate(loader):
        ...
        loss_func = mixup_criterion_triple(targets_a, targets_b, targets_c, lam)
