...
class SEShuffleNetV2(nn.Module):
    ...
    def __init__(self, num_classes, width_multiplier):
        ...
        width_config = {
            ...
            1.8: (192, 384, 768, 1536), ### blocks_nums: 5, 9, 4, 1
        }
        ...
        self.network_config = [
            ...
            (width_config[0], 2, 1, 5, 'b'),
            (width_config[1], 2, 1, 9, 'b'), # x16
...
def se_shufflenet_v2(num_classes=1000, widen_factor=1.8):
    model = SEShuffleNetV2(num_classes=num_classes, width_multiplier=widen_factor)
    return model
