...
cls_proto = 'deploy-cls-pulp.prototxt'  
cls_model = 'models/B-stage-pulp-cls_iter_60000.caffemodel'

final_proto = 'deploy-cls-pulp-E.prototxt'  
final_model = 'E-concat-pulp-cls-pretrain.caffemodel'
