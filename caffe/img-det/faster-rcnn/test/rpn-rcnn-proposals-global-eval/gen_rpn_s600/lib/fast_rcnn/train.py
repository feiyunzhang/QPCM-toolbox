...
class SolverWrapper(object):
    ...
    def snapshot(self):
        ...
        scale_bbox_params_faster_rcnn = (cfg.TRAIN.BBOX_REG and
                             ...
                             net.params.has_key('bbox_pred_det'))
        ...
        if scale_bbox_params_faster_rcnn:
            ...
            orig_0 = net.params['bbox_pred_det'][0].data.copy()
            orig_1 = net.params['bbox_pred_det'][1].data.copy()

            # scale and shift with bbox reg unnormalization; then save snapshot
            net.params['bbox_pred_det'][0].data[...] = \
                    (net.params['bbox_pred_det'][0].data *
                     self.bbox_stds[:, np.newaxis])
            net.params['bbox_pred_det'][1].data[...] = \
                    (net.params['bbox_pred_det'][1].data *
        ...
        if scale_bbox_params_faster_rcnn:
            ...
            net.params['bbox_pred_det'][0].data[...] = orig_0
            net.params['bbox_pred_det'][1].data[...] = orig_1
        if scale_bbox_params_rfcn:
            # restore net to original state
