...
# Overlap threshold for Second_Stage
__C.TRAIN.FG_THRESH_Stage_2nd = 0.5
__C.TRAIN.BG_THRESH_HI_Stage_2nd = 0.5
__C.TRAIN.BG_THRESH_LO_Stage_2nd = 0.0

# Overlap threshold for Third_Stage
__C.TRAIN.FG_THRESH_Stage_3rd = 0.6
__C.TRAIN.BG_THRESH_HI_Stage_3rd  = 0.6
__C.TRAIN.BG_THRESH_LO_Stage_3rd  = 0.0
