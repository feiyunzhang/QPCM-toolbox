...
train_proto = 'deploy.prototxt'  
train_model = 'refinedet-res18-t0_iter_5000.caffemodel'  #should be your snapshot caffemodel

deploy_proto = 'deploy_mbn.prototxt'  
save_model = 'refinedet-res18-t0_iter_5000_mbn.caffemodel'
