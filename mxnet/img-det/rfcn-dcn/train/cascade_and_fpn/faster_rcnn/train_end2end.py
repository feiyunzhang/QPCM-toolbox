...
def train_net(args, ctx, pretrained, epoch, prefix, begin_epoch, end_epoch, lr, lr_step):
    ...
    eval_metric2 = metric.RCNNAccMetric2(config)
    cls_metric2 = metric.RCNNLogLossMetric2(config)
    bbox_metric2 = metric.RCNNL1LossMetric2(config)

    eval_metric3 = metric.RCNNAccMetric3(config)
    cls_metric3 = metric.RCNNLogLossMetric3(config)
    bbox_metric3 = metric.RCNNL1LossMetric3(config)
    ...
    for child_metric in [rpn_eval_metric, rpn_cls_metric, rpn_bbox_metric,
                         ...
                         eval_metric2, cls_metric2, bbox_metric2,
                         eval_metric3, cls_metric3, bbox_metric3]:
